...
<div class ="card">
	<div class="card-content black-text">
		<button class="btn waves-effect waves-light left" id='selectIMG'>Photo
    					<i class="material-icons left">camera_alt</i>
  			  </button>
		<form action="#" id='new_post'>
			<img class="circle responsive-img" id="imgOutp" src="images/alt.png" style='width: 100%; height: 350px; margin-top: 10px; '/>
		    ...
		    <form class="col s12">
		      <div class="row">
		        ...
		        <div class="input-field col s12">
		         ...
		         <div class="input-field col s12">
		          <input id="bday" type="date" class="validate">
		        </div>
